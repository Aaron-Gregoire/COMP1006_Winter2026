    ...
    <div class="col-lg-8">
        <div class="card shadow">
            <div class="card-header bg-warning text-dark">
                <h4 class="mb-0">Edit Task: <?php echo htmlspecialchars($formData['task_name'] ?? 'Unknown'); ?></h4>
            </div>
            <div class="card-body">
                ...
                <form action="edit.php?id=<?php echo $taskId; ?>" method="POST" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php if(isset($errors['task_name'])) echo 'is-invalid'; ?>"
                               ...
                               value="<?php echo htmlspecialchars($formData['task_name'] ?? ''); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.25" min="0" 
                                   class="form-control <?php if(isset($errors['time_spent'])) echo 'is-invalid'; ?>"
                                   id="time_spent" name="time_spent" 
                                   value="<?php echo htmlspecialchars($formData['time_spent'] ?? ''); ?>">
                            <div class="form-text">Example: 1.5 = 1 hour 30 minutes</div>
